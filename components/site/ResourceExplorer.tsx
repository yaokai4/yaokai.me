        ...
        <div className="grid gap-5">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <Link key={resource.id} href={resource.url} target="_blank" className="premium-glass-card group block rounded-md p-5">
              ...
              <p className="mt-4 rounded-md border border-slate-200/70 bg-white/60 p-3 text-xs leading-6 text-slate-500">{t.useCasePrefix}{resource.useCase}</p>
  ...
  return (
    <Link href={resource.url} target="_blank" className="gradient-border-card group grid overflow-hidden rounded-md p-0 lg:grid-cols-[0.8fr_1.2fr]">
      ...
      <div className="p-6 md:p-8">
        ...
        <p className="mt-5 rounded-md border border-slate-900/10 bg-white/72 p-3 text-sm leading-6 text-slate-600">{t.useCasePrefix}{resource.useCase}</p>
